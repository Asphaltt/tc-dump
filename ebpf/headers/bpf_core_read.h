...
#define ___rd_last(fn, ...)                                 \
    ___read(fn, &__t, ___type(___nolast(__VA_ARGS__)), __t, \
        ___last(__VA_ARGS__));
#define ___rd_p1(fn, ...) \
    const void *__t;      \
...
#define BPF_PROBE_READ_INTO(dst, src, a, ...)                      \
    ({ ___core_read(bpf_probe_read, bpf_probe_read, dst, (src), a, \
        ##__VA_ARGS__) })
...
#define BPF_PROBE_READ_STR_INTO(dst, src, a, ...)                      \
    ({ ___core_read(bpf_probe_read_str, bpf_probe_read, dst, (src), a, \
        ##__VA_ARGS__) })
...
#define BPF_PROBE_READ_USER_STR_INTO(dst, src, a, ...)                        \
    ({ ___core_read(bpf_probe_read_user_str, bpf_probe_read_user, dst, (src), \
        a, ##__VA_ARGS__) })
